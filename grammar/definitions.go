...
func (g *Definition) Ast() ast.Expression {
	...
	var params []*parameters.Param = nil
...
func (g *NameParlist) Ast() []*parameters.Param {
	params := make([]*parameters.Param, 0, 1+len(g.Params))
...
func (g *Param) Ast() *parameters.Param {
	...
	if g.Name1 != nil {
		...
		name = g.NameParlist.NameLpar.Name
		params = make([]*parameters.Param, 0, len(g.NameParlist.Params)+1)
