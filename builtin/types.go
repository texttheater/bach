...
var TypeFuncers = []shapes.Funcer{
	shapes.Funcer{
		...
		Examples: []shapes.Example{
			...
			{`[] type`, `Str`, `"Tup<>"`, nil},
			{`["dog", "cat"] type`, `Str`, `"Tup<Str, Str>"`, nil},
			{`["dog", 1] type`, `Str`, `"Tup<Str, Num>"`, nil},
			{`["dog", 1, {}] type`, `Str`, `"Tup<Str, Num, Obj<Void>>"`, nil},
			{`["dog", 1, {}, 2] type`, `Str`, `"Tup<Str, Num, Obj<Void>, Num>"`, nil},
			...
			{`{e: [], d: "", c: 0, b: false, a: null} type`, `Str`, `"Obj<a: Null, b: Bool, c: Num, d: Str, e: Tup<>, Void>"`, nil},
			{`{f: {}, e: [], d: "", c: 0, b: false, a: null} type`, `Str`, `"Obj<a: Null, b: Bool, c: Num, d: Str, e: Tup<>, f: Obj<Void>, Void>"`, nil},
